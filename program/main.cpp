...
int main() {
	Squirtle aguin = Squirtle("aguin",'A',15,10,10,50,5);
	Charmander foguin = Charmander("foguin",'F',15,10,10,50,5);
	Bulbasauro verdin = Bulbasauro("verdin",'G',15,10,10,50,5);
